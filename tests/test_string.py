...
class StringTest(unittest.TestCase):
    ...
    def test_del(self):
        self.assertTrue(self.r.set(self.k1, self.v1))
        self.assertEqual(self.v1, self.r.get(self.k1), "delCommand getequal error1")

        self.assertTrue(self.r.set(self.k2, self.v2))
        self.assertEqual(self.v2, self.r.get(self.k2), "delCommand getequal error2")

        self.assertEqual(self.r.delete(self.k1, self.k2), 2, 'delCommand execute error')
    ...
    def test_getset(self):
        self.assertIsNone(self.r.getset(self.k1, self.v1))
        self.assertEqual(self.r.get(self.k1), self.v1)
